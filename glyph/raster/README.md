...
This directory contains rasterized images (`.png`) of Hijaiyyah characters and debug artifacts.

## 1. Contents
- **Character Glyphs**: Raster versions of Hijaiyyah letters (e.g., `ء.png`, `ه.png`).
...
- OCR validation in `hijaiyyahlang-hl18`.
